...
public class c1_properties_practice {
    ...
    public void TC1_System_properties(){
       // java has data basically we can get some properties that we can get as a system info
        System.out.println(System.getProperty("os.name"));
    }
    @Test
    public void configurationProperties() throws FileNotFoundException {
        //to be able to make our code understand properties file You need to connect file
        Properties properties = new Properties();

        //this is a path for configuration.properties file ***** IMPORTANT
